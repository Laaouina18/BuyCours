...
<div class="host_version">
							...
							<div class="row">
								<div class="col-md-12 col-sm-12 text-right">
									<div class="big-tagline">
										<h2><strong>BuyCours</strong> education </h2>
	...
	<div class="carousel-item">
		<div id="home" class="first-section" style="background-image:url('@assests/img/slider-02.jpg');" >
			<div class="dtab">
				<div class="container">
					<div class="row">
						<div class="col-md-12 col-sm-12 text-left">
							<div class="big-tagline">
								<h2 :data-animation="'animated zoomInRight'">BuyCours<strong>education school</strong></h2>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12">
                    <div class="message-box">
                        <h4>2018 BEST BuyCours education school</h4>
                        <h2>Welcome to BuyCours education school</h2>
                    ...
                    <div class="testi-carousel owl-carousel owl-theme">
                        <div class="testimonial clearfix">
							<div class="testi-meta">
                                <img src="@/assets/img/testi_01.png" alt="" class="img-fluid">
                        ...
                        <div class="testimonial clearfix">
							<div class="testi-meta">
                                <img src="@/assets/img/testi_02.png" alt="" class="img-fluid">
                        ...
                        <div class="testimonial clearfix">
							<div class="testi-meta">
                                <img src="@/assets/img/testi_03.png" alt="" class="img-fluid ">
                                <h4>Venanda Mercy </h4>
                            </div>
                            <div class="desc">
        ...
        <div class="container">
            <div class="row logos">
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="@/assets/img/logo_01.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="@/assets/img/logo_02.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="@/assets/img/logo_03.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="@/assets/img/logo_04.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="@/assets/img/logo_05.png" alt="" class="img-repsonsive"></a>
                </div>
                <div class="col-md-2 col-sm-2 col-xs-6 wow fadeInUp">
                    <a href="#"><img src="@/assets/img/logo_06.png" alt="" class="img-repsonsive"></a>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
    </div><!-- end section -->
...
#testimonials{
    background-image: url("@/assets/img/parallax_04.jpg");
}
</style>
